...
public interface Structured {
     ...
     * are equal.
     */
    record DataPoint(Structured.DataStructure dataStructure, List<Object> objects) implements List<Object> {
        ...
        /**
         * Create a new instance with the given {@link Structured.DataStructure} and a map of values.
         *
         ...
         */
        public DataPoint(Structured.DataStructure dataStructure, Map<String, Object> map) {
            this(dataStructure, map.entrySet().stream()
                    .sorted(Map.Entry.comparingByKey(Comparator.comparingInt(dataStructure::indexOfKey)))
         ...
         * @param dataStructure the data structure
         */
        public DataPoint(Structured.DataStructure dataStructure) {
            this(dataStructure, Arrays.asList(new Object[dataStructure.size()]));
        }

        /**
         * Create a new instance with the given {@link Structured.DataStructure} and a collection of values.
         *
         ...
         */
        public DataPoint(Structured.DataStructure dataStructure, Collection<Object> collection) {
            this(dataStructure, (List<Object>) collection);
        }
         ...
         * @throws IndexOutOfBoundsException if the name is not in the {@link Structured.DataStructure}.
         */
        public Object get(String column) {
            return this.objects.get(dataStructure.indexOfKey(column));
        }
        ...
        public boolean equals(Object o) {
            if (this == o) return true;
            if (o == null || getClass() != o.getClass()) return false;
            if (o instanceof Structured.DataPoint otherDataPoint) {
                return equals(otherDataPoint);
            }
            return false;
        }

        private boolean equals(Structured.DataPoint objects) {
